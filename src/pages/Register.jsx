...
/* --- MOCK TESTIMONIALS (Reused for Consistency) --- */
const TESTIMONIALS = [
  {
    id: 1,
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-neutral-950 text-neutral-200 font-sans selection:bg-purple-500/30">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 lg:p-24 relative overflow-y-auto">
        ...
        >
          ...
          {/* Social Login */}
          <button className="w-full flex items-center justify-center gap-3 bg-white text-neutral-900 font-semibold py-3 px-4 rounded-xl hover:bg-neutral-200 transition-all duration-200 transform hover:scale-[1.01]">
